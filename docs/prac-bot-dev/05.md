...
其次，对于基于 Windows 的 Azure 设置，我们还需要包含一个自定义的 web.config 文件来告诉互联网信息服务(IIS) <sup>[2](#Fn2)</sup> 如何运行 Node 应用。 <sup>[3](#Fn3)</sup>
...
让我们用对话式设计来实现这个完整的循环。在第 [4](04.html) 章中，我们讨论了如何使用我们称之为*对话*的 Node 图来建立对话模型。到目前为止，在这一章中，我们已经学习了瀑布，以及如何用代码建立对话模型。
