...
运行和测试这段代码应该不会在应用程序中显示任何变化；您仍然会看到一个包含两行问题的表，就像以前一样。
...
尽管我们在构造函数中设置了初始状态，但是常规的 SPA 组件不太可能静态地拥有初始状态。这些通常是从服务器上获取的。在问题跟踪器应用程序的情况下，甚至要显示的初始问题列表也必须通过 API 调用来获取。
...
![../images/426054_2_En_4_Chapter/426054_2_En_4_Fig1_HTML.jpg](../images/426054_2_En_4_Chapter/426054_2_En_4_Fig1_HTML.jpg)
...
但我们只会追加一个问题，而不会改变现有的问题。制作数组的浅层副本相当简单，目前这就足够了。因此，我们不会使用这个库——我们不需要编写太多额外的代码来处理它。如果在您的应用程序中，您发现由于状态中对象的深度嵌套，您必须制作大量副本，您可以考虑使用`immutable.js`。
...
![../images/426054_2_En_4_Chapter/426054_2_En_4_Fig2_HTML.jpg](../images/426054_2_En_4_Chapter/426054_2_En_4_Fig2_HTML.jpg)
...
![../images/426054_2_En_4_Chapter/426054_2_En_4_Fig3_HTML.jpg](../images/426054_2_En_4_Chapter/426054_2_En_4_Fig3_HTML.jpg)
...
这些更改的效果在用户界面中看不到。应用程序将像以前一样运行。在刷新浏览器时，您将看到一个空的表格，很快就会填充两个问题，两秒钟后，将添加另一个问题。
...
![../images/426054_2_En_4_Chapter/426054_2_En_4_Fig4_HTML.jpg](../images/426054_2_En_4_Chapter/426054_2_En_4_Fig4_HTML.jpg)
...
![../images/426054_2_En_4_Chapter/426054_2_En_4_Fig5_HTML.jpg](../images/426054_2_En_4_Chapter/426054_2_En_4_Fig5_HTML.jpg)
...
![../images/426054_2_En_4_Chapter/426054_2_En_4_Fig6_HTML.jpg](../images/426054_2_En_4_Chapter/426054_2_En_4_Fig6_HTML.jpg)
...
将应用程序分成组件和子组件。通常，这将反映数据模型本身。例如，在问题跟踪器中，问题数组由`IssueTable`组件表示，每个问题由`IssueRow`组件表示。
...
在设计良好的应用程序中，大多数组件都是其属性的无状态函数。所有的状态都将在层次结构顶部的几个组件中被捕获，所有后代的道具都是从这些组件中派生出来的。
