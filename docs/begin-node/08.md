...
![9781484201886_Fig08-01.jpg](../Images/9781484201886_Fig08-01.jpg)
...
一旦安装完毕，你只需启动软件，连接到 MongoDB 服务器，你就可以看到数据库、集合和文档，如图 8-2 所示。这个应用程序的一个优点是它将`mongo` shell 集成到了它的 GUI 中，因此您所有的终端技能在这里都是相关的。

![9781484201886_Fig08-02.jpg](../Images/9781484201886_Fig08-02.jpg)
