...
![Image](../Images/sq.jpg) **注意**这一节我们说的是 Node.js，不是浏览器 JavaScript。通常，您不希望在前端暴露您的密码和 API 密钥。
...
![Image](../Images/sq.jpg) **提示**关于如何使用 streams 的更多信息，substack 的 James Halliday ( `http://substack.net/`)提供了一些惊人的资源:stream-handbook ( `https://github.com/substack/stream-handbook`)和 stream-adventure ( `https://npmjs.org/package/stream-adventure`)。
...
![9781484200384_Fig11-01.jpg](../Images/9781484200384_Fig11-01.jpg)
...
![9781484200384_Fig11-02.jpg](../Images/9781484200384_Fig11-02.jpg)
...
![Image](../Images/sq.jpg) **提示**在某些情况下，拥有不消耗太多资源的直通逻辑是很好的。为此，请通过(`https://npmjs.org/package/through`)查看模块；GitHub: `https://github.com/dominictarr/through`)。另一个有用的模块是 concat-stream(`https://npmjs.org/package/concat-stream`；GitHub: `https://github.com/maxogden/node-concat-stream`)。它允许流的连接。
